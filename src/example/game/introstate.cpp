    ...
    void IntroState::RenderUI(const u64 frame, const u64 totalMSec, const f32 deltaTNeeded) {
        ...
        */
        ...
        if (ImGui::Button("Open")) {
            ...
            const NFD::Result result = NFD::OpenDialog(path, NFD::EmptyFilter, 0, NFD::EmptyDefaultPath,
                                                       nw);    // Freezes execution of the Game
        ...
        if (ImGui::Button("OpenMultiple")) {
            ...
            const NFD::Result result = NFD::OpenDialogMultiple(paths, NFD::EmptyFilter, 0,
                                                               NFD::EmptyDefaultPath);     // Freezes execution of the Game
        ...
        if (ImGui::Button("Save")) {
            NFD::UniquePathN path;
            const NFD::Result result = NFD::SaveDialog(path, NFD::EmptyFilter, 0,
                                                       NFD::EmptyDefaultPath);     // Freezes execution of the Game
        ...
        if (ImGui::Button("PickFolder")) {
            NFD::UniquePathN path;
            const NFD::Result result = NFD::PickFolder(path,
                                                       NFD::EmptyDefaultPath);     // Freezes execution of the Game
